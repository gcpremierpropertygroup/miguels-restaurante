/* Miguel's Restaurante — translation dictionary.

   Spanish lives at its own URLs under /es/, generated by tools/build-es.py,
   so the pages arrive already translated and nothing here rewrites them on
   load. Language is read from the path, never from storage: a stored
   preference would make an English URL render Spanish, which would break
   sharing and confuse a search engine about what each URL contains.

   This file still ships because the reservation dialog is built in JS after
   the page loads, so it has to translate itself. reserve.js calls the
   MiguelsI18n API below. DICT stays the single source of truth for both the
   dialog and the static page generator. */
...
(function () {
  ...
  var DICT = {
    ...
    /* ---------- per-page <head> metadata ----------
       Used only by tools/build-es.py. They live here so every Spanish
       string in the project has one home. */
    'meta.index.title': { en: "Miguel's Restaurante — Where Culture Meets Cuisine | Ridgeland, MS", es: "Miguel's Restaurante — Donde la Cultura se Encuentra con la Cocina | Ridgeland, MS" },
    'meta.index.desc': { en: "Steak, seafood, authentic Oaxaca dishes and Southern lunch specials in Ridgeland, Mississippi. Family-owned, cooked by Executive Chef Miguel Martinez. 587 Highway 51 J.", es: "Carnes, mariscos, platillos auténticos de Oaxaca y especiales sureños de almuerzo en Ridgeland, Mississippi. Negocio familiar, cocinado por el chef ejecutivo Miguel Martinez. 587 Highway 51 J." },
    'meta.index.ogTitle': { en: "Miguel's Restaurante — Where Culture Meets Cuisine", es: "Miguel's Restaurante — Donde la Cultura se Encuentra con la Cocina" },
    'meta.index.ogDesc': { en: "Steak, seafood, authentic Oaxaca dishes and Southern lunch specials in Ridgeland, Mississippi.", es: "Carnes, mariscos, platillos auténticos de Oaxaca y especiales sureños de almuerzo en Ridgeland, Mississippi." },
    'meta.dinner.title': { en: "The Dinner Table | Miguel's Restaurante — Ridgeland, MS", es: "La Mesa de la Cena | Miguel's Restaurante — Ridgeland, MS" },
    'meta.dinner.desc': { en: "Steak, seafood and authentic Oaxaca dishes, dine-in evenings at Miguel's Restaurante in Ridgeland, Mississippi.", es: "Carnes, mariscos y platillos auténticos de Oaxaca, para comer aquí por la noche en Miguel's Restaurante en Ridgeland, Mississippi." },
    'meta.dinner.ogTitle': { en: "The Dinner Table — Miguel's Restaurante", es: "La Mesa de la Cena — Miguel's Restaurante" },
    'meta.dinner.ogDesc': { en: "Cuts and catches change with what comes in. Steak, seafood and authentic Oaxaca dishes, evenings, dine-in.", es: "Los cortes y la pesca cambian con lo que llega. Carnes, mariscos y platillos auténticos de Oaxaca, por la noche, para comer aquí." },
    'meta.dishes.title': { en: "Signature Dishes | Miguel's Restaurante — Ridgeland, MS", es: "Platillos de la Casa | Miguel's Restaurante — Ridgeland, MS" },
    'meta.dishes.desc': { en: "A look at what comes out of the kitchen at Miguel's Restaurante: tomahawk steak with b&eacute;arnaise, grilled oysters, Oaxaca adobo fish, chicken fried steak and more.", es: "Un vistazo a lo que sale de la cocina en Miguel's Restaurante: corte tomahawk con bearnesa, ostiones asados, pescado adobado de Oaxaca, bistec empanizado y más." },
    'meta.dishes.ogTitle': { en: "Signature Dishes — Miguel's Restaurante", es: "Platillos de la Casa — Miguel's Restaurante" },
    'meta.dishes.ogDesc': { en: "A few things we're known for: tomahawk steak with b&eacute;arnaise, grilled oysters, Oaxaca adobo fish, chicken fried steak and more.", es: "Algunas cosas por las que nos conocen: corte tomahawk con bearnesa, ostiones asados, pescado adobado de Oaxaca, bistec empanizado y más." },
    'meta.lunch.title': { en: "Southern Lunch Specials | Miguel's Restaurante — Ridgeland, MS", es: "Especiales Sureños de Almuerzo | Miguel's Restaurante — Ridgeland, MS" },
    'meta.lunch.desc': { en: "Three Southern plate lunches a day, Monday through Friday, every special $16.50. Miguel's Restaurante in Ridgeland, Mississippi.", es: "Tres platos sureños al día, de lunes a viernes, cada especial $16.50. Miguel's Restaurante en Ridgeland, Mississippi." },
    'meta.lunch.ogTitle': { en: "Southern Lunch Specials — Miguel's Restaurante", es: "Especiales Sureños de Almuerzo — Miguel's Restaurante" },
    'meta.lunch.ogDesc': { en: "Three plates a day, a different three every day. Every special is $16.50. Monday through Friday.", es: "Tres platos al día, tres diferentes cada día. Cada especial cuesta $16.50. De lunes a viernes." },
    'meta.story.title': { en: "Our Story — Chef Miguel Martinez | Miguel's Restaurante", es: "Nuestra Historia — Chef Miguel Martinez | Miguel's Restaurante" },
    'meta.story.desc': { en: "Family-owned since March 7, 2026. Executive Chef Miguel Martinez cooks steak, seafood, authentic Oaxaca dishes and Southern lunch specials himself, in Ridgeland, Mississippi.", es: "Negocio familiar desde el 7 de marzo de 2026. El chef ejecutivo Miguel Martinez cocina él mismo carnes, mariscos, platillos auténticos de Oaxaca y especiales sureños de almuerzo, en Ridgeland, Mississippi." },
    'meta.story.ogTitle': { en: "Our Story — Miguel's Restaurante", es: "Nuestra Historia — Miguel's Restaurante" },
    'meta.story.ogDesc': { en: "Family-owned since March 7, 2026. Cooked by Executive Chef Miguel Martinez, in the kitchen at every service.", es: "Negocio familiar desde el 7 de marzo de 2026. Cocinado por el chef ejecutivo Miguel Martinez, en la cocina en cada servicio." },
    'meta.visit.title': { en: "Visit Us — Directions &amp; Hours | Miguel's Restaurante", es: "Visítanos — Cómo Llegar y Horario | Miguel's Restaurante" },
    'meta.visit.desc': { en: "Miguel's Restaurante, 587 Highway 51 J, Ridgeland, MS 39157. Southern plate lunches Monday through Friday, steak and seafood dine-in evenings. Call (769) 300-3032.", es: "Miguel's Restaurante, 587 Highway 51 J, Ridgeland, MS 39157. Almuerzos sureños de lunes a viernes, carnes y mariscos por la noche para comer aquí. Llama al (769) 300-3032." },
    'meta.visit.ogTitle': { en: "Visit Miguel's Restaurante", es: "Visita Miguel's Restaurante" },
    'meta.visit.ogDesc': { en: "587 Highway 51 J, Ridgeland, MS 39157. Southern plate lunches Monday through Friday. Steak and seafood in the evening, dine-in.", es: "587 Highway 51 J, Ridgeland, MS 39157. Almuerzos sureños de lunes a viernes. Carnes y mariscos por la noche, para comer aquí." },
  };

  /* The /es/ prefix is what makes a page Spanish. */
  function currentLang() {
    var path = window.location.pathname;
    return path === '/es' || path.indexOf('/es/') === 0 ? 'es' : 'en';
  }
  ...
  /* No applyLang on load. Both language versions are pre-rendered, so
     translating again here would only risk fighting the served markup. */
})();
