...
(function () {
  ...
  var DICT = {
    ...
    'visit.gallery.exteriorEntrance.name': { en: 'Golden hour', es: 'La hora dorada' },
    'visit.gallery.exteriorEntrance.note': { en: 'Come by for sunset.', es: 'Ven a la puesta de sol.' },
  };
