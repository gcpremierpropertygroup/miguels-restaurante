...
- `for-Codex-design/photos/` — the source photo/video set (real restaurant photos) handed to a Codex Design project; this is the canonical source of truth for original, unedited assets
